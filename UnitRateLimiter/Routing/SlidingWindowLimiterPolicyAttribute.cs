...
namespace UnitRateLimiter.Routing
{
    ...
    public sealed class SlidingWindowLimiterPolicyAttribute : Attribute, ISlidingWindowLimiterMetadata
    {
        ...
        /// <summary>
        /// 初始化 <see cref="SlidingWindowLimiterPolicyAttribute"/> 类的新实例。
        /// </summary>
        ...
        public SlidingWindowLimiterPolicyAttribute(int permitLimit, int windowSeconds, int segmentsPerWindow)
        {
